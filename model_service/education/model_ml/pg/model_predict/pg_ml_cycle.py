...
from model_ml.pg.model_predict.ml_models.pg_cascade_strategy import PGOptimizationCascade
...
def run_cascade_pipeline():
    ...
    df = pd.read_csv("D:/IdeaProjects/Ver1/model_service/education/model_ml/pg/model_predict/dataset/pg_ml_train_dataset2.csv",
                     sep=';')
